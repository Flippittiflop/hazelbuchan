...
const paperAdvertisingItems = [
  ...
  { id: 4, src: 'https://images.unsplash.com/photo-1586339724140-220f9dfd3b21', alt: 'Paper advertising sample 4', title: 'Paper Sculpture Ad', date: 'September 2023', description: 'A detailed paper sculpture created for a print advertisement, showcasing intricate craftsmanship.' },
  ...
  { id: 6, src: 'https://images.unsplash.com/photo-1586339724140-220f9dfd3b21', alt: 'Paper advertising sample 6', title: 'Interactive Paper Display', date: 'November 2023', description: 'An interactive paper-based display that engages customers through tactile experiences and clever design.' },
];
