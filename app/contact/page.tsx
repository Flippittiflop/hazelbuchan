      ...
      {isSubmitted ? (
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div>
              ...
              />
              {errors.name && <p className="mt-2 text-sm text-red-600">{errors.name.message?.toString()}</p>}
            </div>
            <div>
            ...
            <div>
              ...
              ></textarea>
              {errors.message && <p className="mt-2 text-sm text-red-600">{errors.message.message?.toString()}</p>}
            </div>
